...
# =============================================================================
    ...
    def save_intensities_data(self):
        ...
        ASC500_Scan.save_intensities_data(self, transposed, 'swabian')

    def save_intensities_image(self):
        ASC500_Scan.save_intensities_image(self, self.sum_intensities_image_map, 'swabian')
        
    def save_histogram_arrays(self):
        ASC500_Scan.save_histogram_arrays(self, self.save_data, self.save_time, 'swabian')
